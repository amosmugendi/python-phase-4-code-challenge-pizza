...
with app.app_context():
    # This will delete any existing rows so you can run the seed file multiple times
    ...
    pr1 = RestaurantPizza(restaurant=shack, pizza=cheese, price=15)
    pr2 = RestaurantPizza(restaurant=bistro, pizza=pepperoni, price=20)
    pr3 = RestaurantPizza(restaurant=palace, pizza=california, price=25)
